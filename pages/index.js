      ...
      <div>
        <div
          dangerouslySetInnerHTML={{
            __html: `
        <select on="change:myTabs.toggle(index=event.value, value=true),AMP.setState({sortBox:event.value})">
          <option value="0" [selected]="sortBox=='0'">Select tab 1</option>
          <option value="1" [selected]="sortBox=='1'">Select tab 2</option>
        </select>

        <amp-selector
          id="myTabs"
          role="tablist"
          on="select: AMP.setState({sortBox:event.targetOption})"
        >
          <div role="tabpanel" option="0" selected>
            <div>
              hogehoge
              <img src="" alt="" />
            </div>
    ...
    <style jsx global>
      {`
        ...
        * {
        ...
        .input-group-select > .input-group-select__button:first-child button,
        .input-group-select > .input-group-select__button:first-child input,
        .input-group-select > .input-group-select__button:first-child select,
        .input-group-select
        ...
        .input-group-select
          > .input-group-select__select-2col:first-child
          select,
        .input-group-select > .input-group-select__select:first-child button,
        .input-group-select > .input-group-select__select:first-child input,
        .input-group-select > .input-group-select__select:first-child select {
          border-left: 1px solid #ccc;
        }
        .input-table th {
          padding-right: 16px;
        ...
        @media screen and (min-width: 560px) {
          ...
          .list-ranking__link-summary:hover .lifestyle-list-ranking__label-link,
        ...
        @font-face {
          font-family: icon;
          src: url(http://localhost:3000/icon.ttf?r5m4zg=) format("truetype"),
